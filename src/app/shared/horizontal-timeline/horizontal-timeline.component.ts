...
export class HorizontalTimelineComponent implements AfterViewInit {
  ...
  constructor(){
    ...
    this.timelineWrapper= new ElementRef(null);
    this.eventsWrapper=new ElementRef(null); 
    this.fillingLine=new ElementRef(null); 
    this.eventsContent=new ElementRef(null); 
  ...
  onEventClick(event:any, selectedItem: TimelineElement) {
    event.preventDefault();
    if (this.disabled) {
      return;
    }
  ...
  updateSlide(timelineTotWidth:any, string:any) {
    ...
    if (string === 'next') {
      ...
      this.translateTimeline(translateValue + wrapperWidth - this.eventsMinDistance, 0);
    }
  }

  updateTimelinePosition(string:any, element:any) {
  ...
  updateFilling(selectedEvent:any, filling:any, totWidth:any) {
  ...
  setTimelineWidth(elements: TimelineElement[], width:any, eventsMinLapse: number) {
  ...
  parentElement(element:any, tagName: string) {
  ...
  getTranslateValue(timeline:any) {
  ...
  setTransformValue(element:any, property:any, value:any) {
